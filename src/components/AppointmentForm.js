...
export default function MultiStepBooking() {
    ...
    const validatePersonalInfo = () => {
        ...
        if (formData.mobile.length < 10) newErrors.mobile = "Please enter a valid mobile number"
        setErrors(newErrors)
            ...
            <div className="mx-auto max-w-xl">
                ...
                <div className="mb-8">
                    <div className="relative mx-auto mb-4 flex max-w-[240px] justify-between">
                        <div className={`h-8 w-8 rounded-full ${step >= 1 ? 'bg-rose-400' : 'bg-rose-200'} flex items-center justify-center text-white`}>
                            1
                        </div>
                        <div className={`absolute left-[50%] top-4 h-[2px] w-[80px] -translate-x-[50%] ${step >= 2 ? 'bg-rose-400' : 'bg-gray-200'}`} />
                        <div className={`h-8 w-8 rounded-full ${step >= 2 ? 'bg-rose-400' : 'bg-rose-300'} flex items-center justify-center text-white`}>
                            2
                        </div>
                    </div>
