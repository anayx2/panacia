        ...
        <>
            <section className='relative h-[50dvh] w-full'>
                ...
                <div className="relative z-10 flex h-full items-center justify-center px-4 text-white">
                    <h1 className='text-4xl font-bold tracking-tight lg:text-5xl'> Vitamin B12 Deficiency </h1>
                </div>
            </section>
            ...
            <section className="max-w-7xl mx-auto px-4 py-12 md:py-16 w-[90%]">
                ...
                <p className="mt-5 text-center">
                    At Panacea Health & Beauty Clinic, we provide professional and personalised care to address Vitamin B12 deficiency and help you feel revitalized and healthy. Here’s why you should trust us with your treatment:
                </p>
